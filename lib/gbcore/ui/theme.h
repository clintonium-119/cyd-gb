...
#define UI_COL_HINT_BG   0x39E7 /* the hint footer's pill */
...
#define UI_HELP_H      22 /* one line of prose and the gap under it */
#define UI_FOOT_H      18
 ...
 * font: the smallest GFX font is 9pt, which does not fit a 12 px circle. */
