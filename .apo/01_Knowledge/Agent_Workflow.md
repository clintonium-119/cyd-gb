...
`reference/ORIGINAL_ROADMAP.md` is the closest thing this project has to agent rails, and it addresses agents explicitly at
...
>       is `reference/ORIGINAL_ROADMAP.md` plus this vault's `01_Knowledge/` sufficient?
> - [ ] If committed, should it restate the two governing constraints (`reference/ORIGINAL_ROADMAP.md:14-23`) or link to them?
> - [ ] Are other people working in this repo with agents, or is this single-user?
>
> Look at: `reference/ORIGINAL_ROADMAP.md` §0 and §13, `01_Knowledge/Prompt_Standards.md`.
...
>
> Expected answers when this section is filled:
> - [ ] Do `reference/ORIGINAL_ROADMAP.md` §10 phases map one-to-one onto apo phases, or do they subdivide?
...
> - [ ] What proves a phase done — `reference/ORIGINAL_ROADMAP.md` §10 gives each phase an explicit **Exit:** condition; is
>       that the gate, and who signs it off?
>
> Look at: `reference/ORIGINAL_ROADMAP.md:579-637` (the phase list with exit conditions), `git log --oneline` for the branching
> pattern used so far.
...
[[01_Knowledge/Coding_Standards]] § Test conventions and `reference/ORIGINAL_ROADMAP.md` §11.
